            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((next_head__WEBPACK_IMPORTED_MODULE_2___default()), {
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("title", {
                        children: "Blog Category - OxyBuild"
                    }),
...
const getStaticProps = ({ params  })=>{
    ...
    const filteredblogs = blogs.map((blog)=>{
        return {
            ...blog,
            uniqueCategory: blog.category.find((cate)=>{
                var ref;
                return ((ref = cate === null || cate === void 0 ? void 0 : cate.split('|')[0]) === null || ref === void 0 ? void 0 : ref.trim()) === slug;
            })
        };
    }).filter((blog)=>{
        var ref, ref1;
        return ((ref1 = (ref = blog.uniqueCategory) === null || ref === void 0 ? void 0 : ref.split('|')[0]) === null || ref1 === void 0 ? void 0 : ref1.trim()) === slug;
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,698,932,72,137,190], () => (__webpack_exec__(4559)));
