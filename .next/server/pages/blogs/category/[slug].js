...
const getStaticProps = ({ params  })=>{
    ...
    const filteredblogs = blogs.map((blog)=>({
            ...blog,
            uniqueCategory: blog.category.find((cate)=>cate?.split("|")[0]?.trim() === slug)
...
var __webpack_exports__ = __webpack_require__.X(0, [952,664,698,932,72,137,190], () => (__webpack_exec__(4559)));
