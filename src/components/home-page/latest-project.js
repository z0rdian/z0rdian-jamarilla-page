            ...
            <div className={classes.section_area}>
              <div className={classes.section_with__navigation}>
                <div className={classes.section_title__wrap}>
                  {project_section__items?.map(
                    (project_section__item, index) => {
                      return (
                        <div key={index} className={classes.section_title}>
                          <span>{project_section__item?.subTitle}</span>
                          <h2
                ...
                <div className={classes.section_navigation}>
                  <div className={classes.button_next} ref={prevRef}>
                    <FaChevronLeft />
                  </div>
                  <div className={classes.button_prev} ref={nextRef}>
                    <FaChevronRight />
                  </div>
                </div>
              </div>
            ...
            <div className={classes.slider}>
              ...
              >
                {projects.map((project) => {
                  return (
                    <SwiperSlide className={classes.item} key={project.slug}>
